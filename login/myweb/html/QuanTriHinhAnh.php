...
<head>
    ...
    <link rel="stylesheet" href="css/QLhinhanh.css">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <div class="content">
                        <div id="page-wrapper">
                            ...
                            <div class="title-module">Quản lý hình ảnh</div>
            <div class="filter">
          ...
          <div class="list-course">
                <table class="list-course" >
                    <tr class="row-first">
                        ...
                        <td class="name" width="30">Sửa</td>
                        <td class="name" width="100"><a id="xoa" href="#">Xóa</a></td>
                        <td class="name" width="100">ID</td>
                        <td class="name" width="450">Tiêu đề</td>
                        <td class="name" width="150">Ngày</td>
                    ...
                    <tr>
                        ...
                        <td><a href="#"><img src="image/edit.gif" >
                ...
                <div class="task"><a href="ThemAnh.php"><input type="button" value="Thêm mới" name="Thêm mới"></a>
                    <input type="button" name="Xóa" value="Xóa"> 
                    <a href="CapNhatAnh.php"><input type="button" name="Cập nhật" value="Cập nhật"></a>
    </div>
            </div>
